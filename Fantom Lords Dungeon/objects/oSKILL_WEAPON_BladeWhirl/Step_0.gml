...
if done = true
{
	...
	{
		global.dmgENEMY = round((dmg - target1enemy.thisDEF)/2);
	...
	{
		global.dmgENEMY = round((dmg - target2enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target3enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target4enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target5enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target6enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target7enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target8enemy.thisDEF)/2);
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgLORD = round((dmg - target1lord.thisLord_DEF)/2);
	...
	{
		global.dmgLORD = round((dmg - target2lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target3lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target4lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target5lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target6lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target7lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target8lord.thisLord_DEF)/2);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
