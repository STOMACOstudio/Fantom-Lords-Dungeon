...
//if makeEffect = 5 instance_create_depth(irandom_range(x-32,x+32),irandom_range(y-32,y+32),depth+1,oSKILL_WEAPON_Blizzard2);
...
if done = true
{
	...
	{
		global.dmgLORD = round((dmg - target1lord.thisLord_MAG));
	...
	{
		global.dmgLORD = round((dmg - target2lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target3lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target4lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target5lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target6lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target7lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target8lord.thisLord_MAG));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
