...
if (global.bestiaryFlanDiscovered)
{
	draw_sprite_stretched(sEnemy_Eye,0,x,y,128,128);
	draw_text(x+148,y,"Name: Flan");
	draw_text(x+148,y+28,"Category: Regular");
	draw_text(x+148,y+56,"Location: Sewer");
	draw_text(x+148,y+84,"Killed: " + string(global.bestiaryFlanKilled));
