...
if makeEffect = 5 instance_create_depth(irandom_range(x-32,x+32),irandom_range(y-32,y+32),depth+1,oSKILL_WEAPON_Bloodshed2);
...
if done = true
{
	...
	{
		global.dmgENEMY = round((dmg - target1enemy.thisDEF));
	...
	{
		global.dmgENEMY = round((dmg - target2enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target3enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target4enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target5enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target6enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target7enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgENEMY = round((dmg - target8enemy.thisDEF));
		if global.dmgENEMY <= 0 global.dmgENEMY = 1;
	...
	{
		global.dmgLORD = round((dmg - target1lord.thisLord_DEF));
	...
	{
		global.dmgLORD = round((dmg - target2lord.thisLord_DEF));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target3lord.thisLord_DEF));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target4lord.thisLord_DEF));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target5lord.thisLord_DEF));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target6lord.thisLord_DEF));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round((dmg - target7lord.thisLord_DEF));
		if global.dmgLORD <= 0 global.dmgLORD = 1;
	...
	{
		global.dmgLORD = round(dmg - target8lord.thisLord_DEF);
		if global.dmgLORD <= 0 global.dmgLORD = 1;
