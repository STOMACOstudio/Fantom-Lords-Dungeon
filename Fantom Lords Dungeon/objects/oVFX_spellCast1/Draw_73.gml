...
if (oLord1.thisLord_ascend)
{
	...
	else if (oLord1.spellCast = 1 || oLord1.spellCast = 2)
	{
	...
	else if (oLord1.spellCast = 3 || oLord1.spellCast = 9)
	{
		with oEnemy0_Father
		{
			if (target)
	...
	if (oLord1.spellCast = 10 ) //Berserk
	{
		with oLord0Parent
		{
			draw_rectangle_color(x,y,x+64,y+64,c_lime,c_lime,c_lime,c_lime,true);
	...
	else if (oLord1.spellCast = 4 || oLord1.spellCast = 11 || oLord1.spellCast = 13)
	{
		draw_rectangle_color(oLord1.x,oLord1.y,oLord1.x+64,oLord1.y+64,c_lime,c_lime,c_lime,c_lime,true);
	}
}
