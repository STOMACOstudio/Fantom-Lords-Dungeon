...
if oLordStats.lord3active
{
	if instance_exists(oLord3)
	{
		...
		{
			draw_sprite_ext(sGUI_skillWeaponAscended,oLord3.thisLord_skillWeapon,x,y,1,1,0,thisColor,1);
		}
		else
		{
			draw_sprite_ext(sGUI_skillWeapon,oLord3.thisLord_skillWeapon,x,y,1,1,0,thisColor,1);
		}
