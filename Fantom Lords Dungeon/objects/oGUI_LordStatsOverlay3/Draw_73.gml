...
if instance_exists(oLord3)
{
	...
	if oLord3.thisLord_ACT > oLord3.thisLord_ACTmax  draw_text_transformed_color(mouse_x+18,mouse_y+66,"ACT: " + string(oLord3.thisLord_ACT),0.5,0.5,0,c_green,c_green,c_green,c_green,1);
	else if oLord3.thisLord_ACT < oLord3.thisLord_ACTmax  draw_text_transformed_color(mouse_x+18,mouse_y+66,"ACT: " + string(oLord3.thisLord_ACT),0.5,0.5,0,c_red,c_red,c_red,c_red,1);
	else draw_text_transformed(mouse_x+18,mouse_y+66,"ACT: " + string(oLord3.thisLord_ACT),0.5,0.5,0);
}