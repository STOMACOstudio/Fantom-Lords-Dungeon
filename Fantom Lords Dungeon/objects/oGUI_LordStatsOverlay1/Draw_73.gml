...
if instance_exists(oLord1)
{
	...
	draw_text_transformed(mouse_x+18,mouse_y-14,"LVL: " + string(oLord1.thisLord_level),0.5,0.5,0);
	...
	if oLord1.thisLord_ACT > oLord1.thisLord_ACTmax  draw_text_transformed_color(mouse_x+18,mouse_y+66,"ACT: " + string(oLord1.thisLord_ACT),0.5,0.5,0,c_green,c_green,c_green,c_green,1);
	else if oLord1.thisLord_ACT < oLord1.thisLord_ACTmax  draw_text_transformed_color(mouse_x+18,mouse_y+66,"ACT: " + string(oLord1.thisLord_ACT),0.5,0.5,0,c_red,c_red,c_red,c_red,1);
	else draw_text_transformed(mouse_x+18,mouse_y+66,"ACT: " + string(oLord1.thisLord_ACT),0.5,0.5,0);
}