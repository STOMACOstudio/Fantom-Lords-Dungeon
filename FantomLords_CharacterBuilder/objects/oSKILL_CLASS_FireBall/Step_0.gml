...
if done = true
{
	...
	if target0lord != noone
	{
		global.dmgLORD = dmg - target0lord.thisLord_MAG;
		if global.dmgLORD <= 0 global.dmgLORD = 1;
		target0lord.thisLord_LIF -= global.dmgLORD;
		instance_create_layer(target0lord.x,target0lord.y,"VFX",oGUI_printDMGlord);
	}
