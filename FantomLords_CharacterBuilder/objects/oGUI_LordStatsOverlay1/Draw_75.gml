...
if instance_exists(oLord1)
{
	...
	if oLord1.thisLord_ATK > oLord1.thisLord_ATKmax  draw_text_transformed_color(mouse_x+18,mouse_y+2,"ATK: " + string(oLord1.thisLord_ATK),0.5,0.5,0,c_green,c_green,c_green,c_green,1);
	else draw_text_transformed(mouse_x+18,mouse_y+2,"ATK: " + string(oLord1.thisLord_ATK),0.5,0.5,0);
