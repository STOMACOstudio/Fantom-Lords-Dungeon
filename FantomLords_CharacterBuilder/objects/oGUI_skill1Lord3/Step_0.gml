...
if casting
{
	if oLord3.thisLord_typeAttack == "MELEE"
	{
		...
		if _num > 0
		{
			for (var i = 0; i < _num; ++i;)
				{
					if collision_point(oLord3.x+32,oLord3.y-32,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
					else if collision_point(oLord3.x+96,oLord3.y+32,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
					else if collision_point(oLord3.x+32,oLord3.y+96,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
					else if collision_point(oLord3.x-32,oLord3.y+32,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
	...
	else if oLord3.thisLord_typeAttack == "RANGED"
	{
		...
		var _num2 = collision_rectangle_list(oLord3.x-96,oLord3.y-96,oLord3.x+160,oLord3.y+160,oEnemy0_Father,false,true,_list2,true);
		if _num2 > 0
		{
