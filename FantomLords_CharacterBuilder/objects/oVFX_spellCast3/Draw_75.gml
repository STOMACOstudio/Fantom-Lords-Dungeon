...
if oLord3.spellCast = 0 ||  oLord3.spellCast = 1  ||  oLord3.spellCast = 12 //Fire Ball Hydrobolt Magic Missile
{
	with oMap_0parent
	{
		if stepped
...
if oLord3.spellCast = 3 //Soul Syphon
{
	with oEnemy0_Father
	{
...
if oLord3.spellCast = 7 //Blade Whirl
{
	with oEnemy0_Father
	{
			 if x = oLord3.x && y = oLord3.y-64 draw_rectangle_color(x+1,y+1,x+sprite_width-1,y+sprite_height-1,c_yellow,c_yellow,c_yellow,c_yellow,true);
