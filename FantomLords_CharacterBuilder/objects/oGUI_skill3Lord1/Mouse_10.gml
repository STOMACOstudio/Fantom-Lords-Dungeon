...
if oLordStats.lord1active && instance_exists(oLord1)
{
	...
	else if oLord1.thisLord_skillWeapon = 1
	{
	...
	else if oLord1.thisLord_skillWeapon = 2
	{
	...
	else if oLord1.thisLord_skillWeapon = 4
	{
	...
	else if oLord1.thisLord_skillWeapon = 5
	{
	...
	else if oLord1.thisLord_skillWeapon = 6
	{
	...
	else if oLord1.thisLord_skillWeapon = 7
	{
	...
	else if oLord1.thisLord_skillWeapon = 12
	{
	...
	else if oLord1.thisLord_skillWeapon = 15
	{
	...
	else if oLord1.thisLord_skillWeapon = 16
	{
