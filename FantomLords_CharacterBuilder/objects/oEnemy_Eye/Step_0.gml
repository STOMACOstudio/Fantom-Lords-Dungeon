	...
	else
	{
		if actions >= 2
			...
			if chooseTarget = 0
			{
				if lordTop != noone
				{
					var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordTop.thisLord_DEF;
			...
			else if chooseTarget = 1
			{
				if lordRight != noone
				{
					var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordRight.thisLord_DEF;
					if dmgENEMY <= 0 dmgENEMY = 1;
					global.dmgENEMY = string(dmgENEMY);
			...
			else if chooseTarget = 2
			{
				if lordDown != noone
				{
					var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordDown.thisLord_DEF;
					if dmgENEMY <= 0 dmgENEMY = 1;
					global.dmgENEMY = string(dmgENEMY);
			...
			else if chooseTarget = 3
			{
				if lordLeft != noone
				{
					var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordLeft.thisLord_DEF;
					if dmgENEMY <= 0 dmgENEMY = 1;
					global.dmgENEMY = string(dmgENEMY);
