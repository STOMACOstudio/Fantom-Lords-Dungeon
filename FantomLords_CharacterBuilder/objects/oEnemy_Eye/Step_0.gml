...
{	
	if lordTop != noone
	{
		var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordTop.thisLord_MAG;
	...
	{
		var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordRight.thisLord_MAG;
		if dmgENEMY < 0 dmgENEMY = 0;
		global.dmgENEMY = string(dmgENEMY);
	...
	{
		var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordDown.thisLord_MAG;
		if dmgENEMY < 0 dmgENEMY = 0;
		global.dmgENEMY = string(dmgENEMY);
	...
	{
		var dmgENEMY = (thisMAG + irandom_range(-3,3)) - lordLeft.thisLord_MAG;
		if dmgENEMY < 0 dmgENEMY = 0;
		global.dmgENEMY = string(dmgENEMY);
