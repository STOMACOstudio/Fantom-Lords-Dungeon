	...
	if oLord2.thisLord_typeAttack == "MELEE"
	{
		...
		if _num > 0
		{
			for (var i = 0; i < _num; ++i;)
				{
					if collision_point(oLord2.x+32,oLord2.y-32,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
					else if collision_point(oLord2.x+96,oLord2.y+32,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
					else if collision_point(oLord2.x+32,oLord2.y-96,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
					else if collision_point(oLord2.x-32,oLord2.y+32,_list[| i],false,true)
					{
						_list[| i].image_blend = c_yellow;
						_list[| i].target = true;
					}
