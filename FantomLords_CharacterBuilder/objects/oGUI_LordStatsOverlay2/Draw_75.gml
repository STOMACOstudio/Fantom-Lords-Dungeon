...
if instance_exists(oLord2)
{
	...
	if oLord2.thisLord_ATK > oLord2.thisLord_ATKmax  draw_text_transformed_color(mouse_x+18,mouse_y+2,"ATK: " + string(oLord2.thisLord_ATK),0.5,0.5,0,c_green,c_green,c_green,c_green,1);
	else draw_text_transformed(mouse_x+18,mouse_y+2,"ATK: " + string(oLord2.thisLord_ATK),0.5,0.5,0);
