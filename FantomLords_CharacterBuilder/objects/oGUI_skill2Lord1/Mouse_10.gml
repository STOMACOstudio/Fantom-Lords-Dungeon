...
if oLordStats.lord1active && instance_exists(oLord1)
{
	...
	else if oLord1.thisLord_skillClassArmor = 3
	{
	...
	else if oLord1.thisLord_skillClassArmor = 4
	{
	...
	else if oLord1.thisLord_skillClassArmor = 5
	{
	...
	else if oLord1.thisLord_skillClassArmor = 6
	{
	...
	else if oLord1.thisLord_skillClassArmor = 7
	{
	...
	else if oLord1.thisLord_skillClassArmor = 9
	{
	...
	else if oLord1.thisLord_skillClassArmor = 10
	{
