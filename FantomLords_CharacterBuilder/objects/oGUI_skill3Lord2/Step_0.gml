...
if mouse_x > x && mouse_x < x+32 && mouse_y > y && mouse_y < y+32 && !instance_exists(oGUI_printSkill)
{
	if instance_exists(oLord2)
	{
		...
		else if oLord2.thisLord_skillWeapon = 5 global.printSkill = "STONE SHIELD";
		else if oLord2.thisLord_skillWeapon = 6 global.printSkill = "EXORCISM";
		...
		else if oLord2.thisLord_skillWeapon = 9 global.printSkill = "PROTECT";
		else if oLord2.thisLord_skillWeapon = 10 global.printSkill = "MOON POWER";
		else if oLord2.thisLord_skillWeapon = 11 global.printSkill = "HEALING SONG";
		...
		else if oLord2.thisLord_skillWeapon = 15 global.printSkill = "SCRY";
		else if oLord2.thisLord_skillWeapon = 16 global.printSkill = "HUNT";
